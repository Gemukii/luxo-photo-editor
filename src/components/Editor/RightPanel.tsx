...
export const RightPanel: React.FC = () => {
  ...
  if (!currentImage) {
    return (
      <aside className="w-72 bg-white/70 backdrop-blur-xl border border-white/70 shadow-xl shadow-indigo-200/30 rounded-3xl p-6 flex flex-col items-center justify-center text-center text-slate-400">
  ...
  if (activeTab === 'crop') {
    ...
    return (
      <aside className="w-72 bg-white/80 backdrop-blur-xl border border-white/70 shadow-xl shadow-indigo-200/30 rounded-3xl p-5 flex flex-col gap-5">
